...
export function HolidaysTab({ settings, setSettings }: HolidaysTabProps) {
  ...
  const handleSave = () => {
    ...
    setHasChanges(false);
    console.log('Saving holidays settings (WorkingHoursPage2):', settings);
  };
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <p className="text-base text-gray-600">등록된 휴무일은 근무 외 시간의 응대 규칙에 따라 대응됩니다. (WorkingHoursPage2 버전)</p>
        <SaveCancelButtons
