...
export function LunchBreakTab({ settings, setSettings }: LunchBreakTabProps) {
  ...
  const handleSave = () => {
    ...
    setHasChanges(false);
    console.log('Saving lunch break settings (WorkingHoursPage2):', settings);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-6">
        <p className="text-base text-gray-600">상담사의 식사 시간을 설정해주세요. 일괄 혹은 개인별 설정이 가능합니다. (WorkingHoursPage2 버전)</p>
        <SaveCancelButtons
