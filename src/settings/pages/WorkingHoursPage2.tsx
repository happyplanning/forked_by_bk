...
import { WorkingHoursTab } from '../components/tabs2/WorkingHoursTab';
import { ConsultantBreakTab } from '../components/tabs2/ConsultantBreakTab';
import { LunchBreakTab } from '../components/tabs2/LunchBreakTab';
import { HolidaysTab } from '../components/tabs2/HolidaysTab';

interface WorkingHoursPage2Props {
  settings: Settings;
  setSettings: (settings: Settings) => void;
}

export function WorkingHoursPage2({ settings, setSettings }: WorkingHoursPage2Props) {
